package it.intext.saipem.runnable;
...
public class SaipemGrammarTest {

	static final String ruleFile = "test/saipem.gprset";
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			for (String layer : idx.getLayersName()){
				System.out.println(idx.getLayer(layer).toString(idx));
			}
		}
	}
