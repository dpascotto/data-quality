...
public class AddAction implements Action{
	...
	static final Logger logger = LoggerFactory.getLogger(AddAction.class);
				...
				if (matcher.matches())
				{
					...
					if (text.contains("."))
					{
						try{
							...
							logger.debug("Adding term {} {}.", term, tg.getPositions());
							continue;
						}catch(Exception e){}
					}
					logger.debug("Adding term {} {}.", text, tg.getPositions());
